    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="25%"><a href="{{url('order\mbalipay',['order_id'=>$orderInfo->order_id])}}" class="jiesuan">MB立即支付</a></td>
       <td width="25%"><a href="{{url('order\alipay',['order_id'=>$orderInfo->order_id])}}" class="jiesuan">PC立即支付</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
 @endsection